...
{if and( eq( $attribute.can_translate, 0 ), ne( $object.initial_language_code, $attribute.language_code ) )}
    ...
    {if $is_translating_content}
        <div class="original">
        {attribute_sedit_gui attribute_base=$attribute_base attribute=$attribute view_parameters=$view_parameters}
...
{else}
    {if $is_translating_content}
        ...
        <div class="original">
        {attribute_sedit_gui attribute_base=$attribute_base attribute=$from_content_attributes_grouped_data_map[$attribute_group][$attribute_identifier] view_parameters=$view_parameters}
        </div>
